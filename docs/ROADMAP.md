...
- [ ] Reach the previously requested **464 people total**, including resting figures. The original doubling proposal started at 232; the separate street-life follow-up now has 277 people and 48 moving motor vehicles. Reconcile the remaining human allocation against that newer baseline rather than applying the obsolete 232-person/36-vehicle accounting. This target is not yet implemented and does not itself authorize another vehicle increase.
