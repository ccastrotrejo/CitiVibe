...
**Status: the population-diversity follow-up passes local automated checks; served-browser and physical-device gates remain open.** The current scene retains thirty-six intersections, twenty-four blocks, 94 buildings and a 78 x 176 m park within a 220 x 340 m map. It now has 224 active/posable people (260 rigs including vehicles), eight resting neighbors, two balls and the unchanged courts, entrances and scaffolding. Previous version-005 and merge records below are historical. Automated coverage does not substitute for physical-device FPS, long-session, cross-combination or assistive-technology verification. Production readiness is not claimed; camera-follow and the drone remain excluded.
