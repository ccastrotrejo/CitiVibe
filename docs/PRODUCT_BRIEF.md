...
**Population policy:** 277 people including eight resting picnic neighbors: 168 neighborhood walkers, 48 park walkers, 24 runners, twelve road cyclists, six court players, eight meadow family figures and three bike-station users. The city has 48 moving motor vehicles, retaining its six original buses; twelve parked cars and four sidewalk food carts are separate static scenery. Three bike stations each hold ten bicycles in a parallel side-by-side row, including beside Juniper Court, with visible checkout/redock activity. Road cyclists use matching shared-blue models. This is not a station-to-station rental simulation. Two sports balls remain separate. Thirteen work roles, five age bands, independently varied appearance and purpose-biased pace remain, without careers, selection cards or a demographic simulator. See [people and activity](PEOPLE_AND_ACTIVITY.md).
...
| Population and event density | 277 people including eight resting figures, 48 moving motor vehicles, twelve parked cars, four sidewalk food carts, thirty station bicycles, two sports balls and at most one occasional airplane; no unbounded spawning. | Street-life follow-up; device tuning remains future work. |
