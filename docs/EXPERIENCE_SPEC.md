...
Juniper Court contains a 14 x 7.5 m basketball surface and a 6.7 x 3.05 m pickleball surface, with six animated players and two balls, bringing the fixed total to 132 people/vehicle rigs plus the two ball props. The miniature pickleball area is below one quarter of basketball's; neither is a regulation-facility claim. Basketball players dribble into drives, pass, shoot, pursue rebounds and reposition. Pickleball players move to meet rallies that cross the net and bounce on the receiving side. Readable footwork and changing player positions are required, not fixed standing rigs with only arm animation or sliding poses. They are non-interactive ambient scenes, not competitive sports simulations. Pause, hidden pages and context loss freeze their retained clock; restoration reconstructs the same pose. Reduced motion holds the entire court scene still. The shared landmark description provides a nonvisual account without announcing each play.
