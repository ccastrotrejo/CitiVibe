...
**Current execution state: weather-physics work resumed at the user's explicit request on 2026-09-12.** The M1-M5 foundation, environment/audio, and occasional airplane are connected to the live experience. The current task extends simulated rain, snow, wind, surface water/snow, visible accumulating snow depth, rain-fed ground pools, rain intensity, and their street-activity effects, supported by source-verified physics research. The user also requested a standalone lower-left Settings trigger/non-modal dock, interface polish, and a pull request when the work is finished. This is not authorization to start unrelated milestone work during this slice. The NYC visual pass and final hardening remain separate work.
