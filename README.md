...
**NYC architectural character:** 56 masonry and brownstone elevations now emphasize the ground-floor base and roofline instead of repeating a continuous stripe on every upper floor. Twenty-six tenements have taller sash proportions; those buildings and eight metal lofts gain dark projecting cornices with real friezes and brackets. Brownstone principal windows gain stone side surrounds. Attached lots, storefronts, roof equipment, the full population and all controls remain; no grid, building count or scene-budget expansion is introduced. See the [implementation and visual limitations](docs/ACCEPTANCE_CRITERIA.md#nyc-architectural-character---2026-09-17).

**NYC realism:** the [research and implementation record](docs/NYC_REALISM_RESEARCH_PLAN.md#local-implementation-record---2026-09-17) covers the 37 approved improvements: coherent building/frontage/roof systems, street and park details, purposeful activity, drains, retained-time window lighting and bounded steam plumes. Mailboxes, benches, fifteen hydrants and four steam stacks now belong to **interior plazas, forecourts and curb pockets**, not the exposed city border. Thirty street drains line interior curb segments while skipping bike-track and parking sides. A hospital, fire station and police station have distinct original exteriors and twelve existing adult employees. Optional scale/grid and skyline expansion remain excluded. Integrated source and installed-Chrome checks pass; the [current verification record](docs/ACCEPTANCE_CRITERIA.md#nyc-realism-and-interior-placement---2026-09-17) distinguishes these results from the historical research baseline and remaining visual/device gates.

**NYC-inspired everyday vehicles:** all 38 ordinary moving vehicles and twelve parked cars now share a more legible design vocabulary. Passenger cars have ID-stable sedan, hatch and crossover silhouettes; yellow taxis mix sedans and passenger minivans. Cargo vans have opaque low/high-roof compartments, box trucks separate the cab from a taller loading box, and compressed buses gain curbside passenger doors. Shared parked-car shells correct the old oversized proportions. The approved emergency fleet, traffic reservations, routes and behavior remain unchanged. See the [source/evidence record](docs/NYC_ORDINARY_VEHICLES_RESEARCH.md) and [current verification](docs/ACCEPTANCE_CRITERIA.md). No brands, ads or downloaded runtime artwork are added.

**NYC-inspired emergency vehicles:** researched patrol SUVs, box/compact ambulances, pumper engines and fire-command SUVs now have distinct bodywork, exposed windshields, service colors and recognizable equipment. Ambulances gain rear patient doors and loading steps; engines gain pump panels, shutters, hose beds and stowed ladders. Two existing sedan slots become unbranded patrol SUVs, keeping their IDs and the 48-vehicle total. Traffic behavior, steady warning lamps, weather, pause and controls remain. See the [nine-source study and provenance](docs/NYC_EMERGENCY_VEHICLES_RESEARCH.md); no department branding or downloaded artwork ships.

**Weather-aware walkers:** rain brings individually timed umbrellas or hooded rainwear, with varied, modest hurry rather than a universal speed boost. Snow brings winter coats and headwear; ground snow keeps movement cautious after the sky clears. The eight existing picnic neighbors stand up, leave through the east park gate, walk on the surrounding sidewalks, and return through the south gate after sustained sunny, warm-enough conditions and a short drying delay. Nobody teleports or disappears. Population remains 328; the same eight formerly static figures now participate in the simulation. [Research, sources and authored behavior](docs/PEOPLE_WEATHER_RESEARCH.md) explain the choices and limits.

**NYC is the continuing visual direction.** The building-fabric pass closes 57 incidental gaps into narrow party-wall joints, connecting 75 of the existing 94 buildings into denser groups. After three civic conversions, the neighborhood distinguishes **17 offices**, **31 mixed-use buildings**, **43 residential buildings** and **three civic facilities**. Construction-specific windows, entries, materials and roofs reinforce related frontage runs. Meaningful planted openings, subway approaches, bicycle access, sidewalks and courts remain clear. The [research and real NYC photo references](docs/NYC_BUILDING_FABRIC_RESEARCH.md) distinguish verified source guidance from design interpretation; no reference photograph or branding is shipped in the application.
...
Rainlight Square has **328 people**: 200 neighborhood walkers, 55 park walkers, 24 runners, fifteen road cyclists, nine roaming shared-bike riders, six court players, eight meadow family figures, three bike-station users and eight picnic neighbors. **48 moving motor vehicles** circulate outside the park; twelve parked cars retain their original curb positions. Four cabless food carts remain in clear sidewalk corner pockets. Six mailboxes and eighteen added street/park benches retain their identities, with the street furniture relocated into the neighborhood. Civic duties, a storefront visit, reading, a connected meadow route and a service-associated pause reuse existing people. Thirteen fictional work roles and independent ages, skin tones, statures, builds, clothes and accessories remain. The older target of **464 people** remains a separate [planned task](docs/ROADMAP.md#next-planned-task---double-the-people), not an implemented doubling.
...
**Verification boundary:** earlier merge results are historical, not verification of later changes. The [acceptance record](docs/ACCEPTANCE_CRITERIA.md) preserves the fleet's served-Chromium results, the realism pass's installed-Chrome results and each runner's limitations separately. Automated checks and source-scene counts do not establish physical-device frame rates, long-session stability or all-angle visual approval.
