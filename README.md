...
**Current work: a larger, more diverse population.** Rainlight Square now has 144 neighborhood walkers, 36 park walkers, eighteen runners, twelve cyclists, six court players and eight meadow family figures: **224 active/posable people**, up from 150, plus eight resting picnic neighbors. The unchanged 36 motor vehicles bring the active rig total to 260, with two sports balls. Thirteen work roles include lawyers, software engineers, analysts, office workers, firefighters, police officers, healthcare staff, construction workers, couriers, chefs, gardeners, teachers and artists. Children, teens and adults through older age have varied statures, builds, skin tones, hair, clothing, hats, glasses and bags. These are original fictional people, not demographic data or a job-selection system. See [people, behavior and research](docs/PEOPLE_AND_ACTIVITY.md).
