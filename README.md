...
**Verification boundary:** main was integrated and pushed at `48dc3fe`. Its automated results are historical, not final verification of the new courts, density, compact subway entrances and additional scaffolding. Served-browser navigation remains blocked, although isolated in-memory WebKit rendering now works. Current results and limitations are recorded in [acceptance criteria](docs/ACCEPTANCE_CRITERIA.md).
