...
**Verification boundary:** earlier merge results are historical, not verification of later changes. The [acceptance record](docs/ACCEPTANCE_CRITERIA.md) distinguishes installed-Chrome results from default software-WebGL runner limitations. Automated checks and source-scene counts do not establish physical-device frame rates, long-session stability or all-angle visual approval.
